...
- shared Home Manager 設定: [`homes/saqula/stylix/default.nix`](../homes/saqula/stylix/default.nix)
- theme asset: `homes/saqula/stylix/rose-pine-moon.yaml`

原則:

- 配色や共通テーマ方針は `homes/saqula/stylix/default.nix`
